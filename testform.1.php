...
<form name="myantispamform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">

 <input type="text" name="name2" id="myP">
 <br><br>
...
$a=time() ;
echo '<br>';
echo 'Page generated in ' . $_SERVER['REQUEST_TIME'];

echo '<br>';
echo 'Page started  in ' .$startScriptTime;
echo '<br>';
